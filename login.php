			...
			<section>
				...
				<div class="row">	
					...
					<div class="col-sm-12 col-md-6 col-lg-6" style="background-color: rgb(179, 226, 185);">			
						<div class="card" style="margin-top: 30dp;">
							<div class="loginBox" style="height: 400px;margin-top: 30dp;">
								<img src="images/logooo.jpeg" class="img-responsive" alt="E-Census Sri Lanka" style="width: 50px; height: 50px;";">
								<h2>Login</h2>
							...
							<hr><p>New to E-Census? <a href="register.php" title="Create an account">Create an account</a>.</p>								
						</div><!-- /.loginBox -->	
					</div><!-- /.card -->
				</div>
				</div><!-- /.col -->
