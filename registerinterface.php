...
?>
  ...
  <div class="container">
	  <section>
		<div class="row">
			<div class="col-sm-12" style="background-color: rgb(95, 143, 103);font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
		...
		<div class="row">
			<div class="col-sm-12 col-md-6 col-lg-6">
				<img class="img-responsive" src="images/imgg.jpg" alt="E-Census" style="width: 800px;
				height: 600px;">
			</div>
...
?></select>
		  ...
		  <button type="submit" class="btn btn-success btn-block" name= "gnregister">Register</button>
	  ...
	  <button type="submit" class="btn btn-success btn-block" name="hhregister">Register</button>
		</div>


	<div >
		<p style="text-align: center;">Already have an account? <a href="http://localhost/NewCensus/login.php" title="Login Here">Login here!</a></p>
	</div>
</div>
